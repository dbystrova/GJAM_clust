...
2.  Download saved models from the following link [models](https://drive.google.com/drive/folders/1ck84t8Lc4oDFFET8S9TVwcM6yYusN85l?usp=sharing) and load the models in the folder "PCA analysis/r5\_models/chain\_1"(2) on your local repository
...
Dimension reduction in GJAM model was proposed by
1
...
2
. It takes as the input \* gjam object fitted model \* K possible number of clusters for initialization of greedy search algorithm \* Clustering used for prior specification
